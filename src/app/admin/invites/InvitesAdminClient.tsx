...
export default function InvitesAdminClient() {
  ...
  return (
    <section className="rounded-lg border border-zinc-800 bg-zinc-950/80 p-4 text-xs text-zinc-200">
      <header className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-md border border-zinc-700 bg-zinc-900 px-2 py-1 text-[11px] text-zinc-100 focus:border-emerald-500 focus:outline-none focus:ring-0"
          >
      ...
      <div className="mt-2 space-y-1">
        {loadState.status === "loading" && (
          <p className="text-[11px] text-zinc-400">Loading requests.</p>
        )}
      ...
      <div className="mt-3 overflow-x-auto rounded-lg border border-zinc-800 bg-black/30">
