    ...
    if (state.status === "success") {
      return (
        <div
          ...
          aria-live="polite"
          aria-atomic="true"
          className="mt-3 rounded-md border border-emerald-600/60 bg-emerald-600/15 px-3 py-2 text-xs text-emerald-100"
        >
    ...
    if (state.status === "error") {
      return (
        <div
          ...
          aria-live="assertive"
          aria-atomic="true"
          className="mt-3 rounded-md border border-rose-600/60 bg-rose-600/10 px-3 py-2 text-xs text-rose-100"
        >
