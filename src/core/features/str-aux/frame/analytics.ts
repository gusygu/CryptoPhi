...
// Legacy exports kept for callers that used to import from analytics.
export {
  runSnapshotWithRefs as runStrAuxWithTimeRefs,
  runSnapshotWithRefs as runStrAuxSnapshot,
  type SnapshotWithRefs,
} from "./index";
export { makeSamplingPlan } from "./schedule";
