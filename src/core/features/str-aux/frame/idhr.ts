...
type Nucleus = { binIndex: number; density: number; firstDegree: number; secondDegree: number };
type IdhrResult = { nuclei: Nucleus[]; sampleFirstDegrees: number[]; outlierCount: number };
