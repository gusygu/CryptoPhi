...
DECLARE v_id bigint;
BEGIN
  INSERT INTO mea_dynamics.cycles(window_label, engine_cycle, selected_base, selected_quote, coins, owner_user_id)
  VALUES (p_window_label, p_engine_cycle, p_base, p_quote, p_coins, p_owner_user_id)
