...
-- Minimal RT session table to satisfy FK references (full runtime variant may be added later)
...
-- Backfill legacy rt_session with columns used by wallet views
