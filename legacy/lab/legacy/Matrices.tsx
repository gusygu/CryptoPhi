...
import { FROZEN_STAGE_COLORS, type FrozenStage } from "../../../src/components/features/matrices/colors";
...
type MetricDescriptor = {
  ...
  subtitle: string;
  accent: string;
  accessor: (row: ApiMatrixRow) => Cell | null | undefined;
...
const METRICS: MetricDescriptor[] = [
  ...
  },
  {
    ...
    formatter: (value) => formatNumber(value, 7),
  },
  {
    key: "pct_snap",
    title: "Snap Alignment",
    subtitle: "Benchmark vs latest snap anchor",
    accent: "#f472b6",
    accessor: (row) => row.snap_block?.top,
    formatter: (value) => formatPercent(value, 3),
  },
  {
    key: "snap",
    title: "Snap Offset",
    subtitle: "Absolute snap adjustment",
    accent: "#0ea5e9",
    accessor: (row) => row.snap_block?.bottom,
    formatter: (value) => formatNumber(value, 7),
  },
  {
    key: "id_pct",
...
function formatNumber(value: number | null, digits = 7): string {
  if (value == null || !Number.isFinite(value)) return "-";
